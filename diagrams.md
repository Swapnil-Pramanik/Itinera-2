...
graph TB
    ...
    style ExtraUC fill:#E0F7FA,stroke:#006064,stroke-width:1px
```
...
sequenceDiagram
    ...
    Auth-->>App: JWT Token
    App->>API: Verify Token via Thread-Safe Cache
    API-->>App: Token Valid
    ...
    API->>Gemini: Generate Packing List (Context: Dest, Weather)
